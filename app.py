...
print(f"MongoDB initialization failed: {type(error).name}")
...
return isinstance(value, str) and value.startswith("data/") and "," in value
...
if mime not in {"data/png", "data/jpeg", "data/jpg", "data/webp"}:
...
print(f"Unexpected application error: {type(error).name}")
